...
int main()
{
	...
	while (marineAlive() || zerglingAlive(*swarm, squadSize)) // If anyone is left alive to fight . . .
	{
		...
		if (zerglingAlive(*swarm, squadSize)) // if there's at least one zergling alive
		{
